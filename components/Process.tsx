    ...
    return (
        <section className="bg-white">
            <div className="max-w-4xl mx-auto px-6">
                ...
                <p className="text-xl md:text-2xl text-gray-600 text-center mb-16 leading-relaxed max-w-3xl mx-auto font-medium">
                    Después de una charla inicial, diseño un proceso adaptado a tu momento actual, tu nivel de estrés y tus objetivos.
                </p>

                <div className="bg-[#E0F2FE]/20 p-10 md:p-16 rounded-[32px] border border-blue-50/50 mb-20 shadow-sm">
