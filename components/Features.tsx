    ...
    <section className="max-w-6xl mx-auto px-6 py-20 space-y-24">
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
        <div className="flex-1 text-left">
          <Tag text="Autoconciencia" color="#FF9EAF" />
          <h3 className="text-4xl font-bold mb-6">Mejorá la autoestima</h3>
          <p className="text-white/80 leading-relaxed text-lg">
            Al centrarse en el momento presente y desarrollar la autocompasión, las personas pueden aumentar la autoconciencia, la positividad y la confianza.
          </p>
        </div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
        <div className="flex-1 text-left">
          <Tag text="Compromiso" color="#FDBA74" />
          <h3 className="text-4xl font-bold mb-6">Estate más presente</h3>
          <p className="text-white/80 leading-relaxed text-lg">
            Nos permite comprometernos plenamente, encontrar alegría en el momento y dejar de lado las preocupaciones y distracciones al estar presentes.
          </p>
        </div>
        <div className="flex-1 flex justify-center">
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 md:gap-24">
        <div className="flex-1 text-left">
          ...
          <h3 className="text-4xl font-bold mb-6">Reducí la ansiedad</h3>
          <p className="text-white/80 leading-relaxed text-lg">
            Mantenerse presente en el momento puede reducir la ansiedad al liberar preocupaciones sobre el futuro y arrepentimientos del pasado.
          </p>
        </div>
        <div className="flex-1 flex justify-center">
