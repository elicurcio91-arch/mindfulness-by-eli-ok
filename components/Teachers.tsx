        ...
        <div className="flex flex-col md:flex-row items-start gap-12 md:gap-20">
          ...
          <div className="w-full md:w-7/12 text-left pt-8">
            ...
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed font-medium">
              <p>
                Soy Eli Curcio, argentina viviendo en Florianópolis, Brasil. Soy profesora de mindfulness con aval internacional, instructora de yoga y coach ontológica.
              </p>
              <p>
                Acompaño procesos online 1:1 con herramientas simples, aplicables a la vida real.
              </p>
            </div>
