      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
        <div>
          <a
            ...
            className="flex items-center gap-3 text-gray-800 font-bold hover:text-green-600 transition-colors py-3"
          >
        ...
        <div className="flex items-center gap-8">
          ...
          <span className="text-gray-400 font-medium text-sm">Sesiones 100% online</span>
        </div>
      </div>

      <div className="max-w-6xl mx-auto mt-12 pt-8 border-t border-gray-50 flex justify-between items-center text-[10px] text-gray-300 uppercase tracking-widest font-bold">
        <span>© 2026 MindfulnessbyEli</span>
