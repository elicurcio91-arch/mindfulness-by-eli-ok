      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 mb-20 text-center md:text-left">
        <div>
          ...
          <a
            ...
            className="flex items-center gap-4 text-gray-900 font-extrabold text-xl hover:text-green-600 transition-colors py-4 px-8 rounded-full border-2 border-gray-100 shadow-sm hover:shadow-md bg-white"
          >
